...
if (runtime4 == null || runtime4.radixDialog == null) {
...
function usePortalScopeProps() {
  const pluginId = true ? "usage" : void 0;
  return {
...
if (runtime5 == null || runtime5.reactDom == null) {
...
// app.tsx
var PLUGIN_ID = "usage";
var FOOTER_BUTTON_SELECTOR = '[aria-label="Usage & limits"]';
var OPEN_MODAL_EVENT = "bb-plugin-usage:open-modal";
...
function MiniBar({ percent }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-1 w-full overflow-hidden rounded-full bg-muted", children: /* @__PURE__ */ jsx(
    "div",
    {
...
function MiniWindowRow({ window: w }) {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-baseline justify-between gap-2 text-[11px] leading-none", children: [
      /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: w.label }),
      /* @__PURE__ */ jsxs(
        "span",
        {
          className: w.usedPercent >= 90 ? "font-medium text-destructive" : "font-medium text-foreground",
          children: [
    ...
    /* @__PURE__ */ jsx(MiniBar, { percent: w.usedPercent })
  ] });
}
function MiniProviderSection({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
    /* @__PURE__ */ jsx("p", { className: "text-xs font-medium text-foreground", children: name }),
    usage.status === "ok" ? usage.windows.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-1.5", children: usage.windows.map((w) => /* @__PURE__ */ jsx(MiniWindowRow, { window: w }, w.label)) }) : /* @__PURE__ */ jsx("p", { className: "text-[11px] text-muted-foreground", children: "No usage data." }) : usage.status === "error" ? /* @__PURE__ */ jsx("p", { className: "text-[11px] text-destructive", children: usage.message }) : /* @__PURE__ */ jsx("p", { className: "text-[11px] text-muted-foreground", children: usage.status === "unauthenticated" ? "Not signed in." : "Session expired." })
  ] });
}
function UsagePopoverContent({ data }) {
  if (!data) {
    return /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Loading usage\u2026" });
  }
  const visible = PROVIDERS.filter(
    (p) => data[p.key].status !== "not_installed"
  );
  if (visible.length === 0) {
    return /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "No providers installed on this machine." });
  }
  return /* @__PURE__ */ jsx("div", { className: "space-y-3", children: visible.map(({ key, name }) => /* @__PURE__ */ jsx(MiniProviderSection, { name, usage: data[key] }, key)) });
}
function useHoverAnchor(selector) {
  const [open, setOpen] = useState(false);
  const [rect, setRect] = useState(null);
  const hoverCount = useRef(0);
  const closeTimer = useRef(void 0);
  const hoverApi = useRef({ enter: () => {
  }, leave: () => {
  } });
  useEffect(() => {
    const cancelClose = () => {
      if (closeTimer.current !== void 0) {
...
function UsageModal({
  ...
  return /* @__PURE__ */ jsx(Dialog2, { open, onOpenChange, children: /* @__PURE__ */ jsxs(DialogContent2, { className: "max-h-[80vh] overflow-y-auto sm:max-w-md", children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle2, { children: "Usage & limits" }),
      /* @__PURE__ */ jsx(DialogDescription2, { children: "Current provider usage on this machine." })
    ] }),
    /* @__PURE__ */ jsx(UsagePopoverContent, { data })
  ] }) });
}
function UsageOverlays() {
  ...
  return /* @__PURE__ */ jsxs(Fragment2, { children: [
    open && rect && !modalOpen ? /* @__PURE__ */ jsx(
      "div",
      {
        ...
        ...panelHandlers,
        children: /* @__PURE__ */ jsx(UsagePopoverContent, { data })
      }
    ) : null,
    /* @__PURE__ */ jsx(
      UsageModal,
...
var app_default = definePluginApp((app) => {
  app.contentScripts.register({
    ...
    mount() {
      ...
      root.render(/* @__PURE__ */ jsx(UsageOverlays, {}));
      return () => {
        root.unmount();
        container.remove();
      };
