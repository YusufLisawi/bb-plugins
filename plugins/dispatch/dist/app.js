...
// src/app/components/OpenCount.tsx
function OpenCount() {
  const rpc = useRpc();
  ...
  useEffect(() => {
    ...
    void load();
    const interval = window.setInterval(() => void load(), 3e4);
    return () => {
      cancelled = true;
      window.clearInterval(interval);
    };
  }, [rpc]);
  return count === null ? null : /* @__PURE__ */ jsx("span", { className: "tabular-nums text-xs text-muted-foreground", children: count });
}
...
function usePortalScopeProps() {
  const pluginId = true ? "dispatch" : void 0;
  return {
...
function Dialog2({
  ...
  const [titleId, setTitleId] = useState(generatedTitleId);
  const [descriptionId, setDescriptionId] = useState(
    generatedDescriptionId
  );
  const registerTitleId = useCallback(
    (id) => {
      setTitleId(id);
  ...
  const registerDescriptionId = useCallback(
    (id) => {
      setDescriptionId(id);
...
var DialogTitle2 = forwardRef(({ asChild, className, id, children, ...props }, ref) => {
  ...
  if (isCompactViewport) {
    ...
    if (asChild) {
      return /* @__PURE__ */ jsx(Slot, { ref, ...titleProps, children });
    }
    return /* @__PURE__ */ jsx("h2", { ref, ...titleProps, children });
  }
  return /* @__PURE__ */ jsx(
    Title,
    {
...
var DialogDescription2 = forwardRef(({ asChild, className, id, children, ...props }, ref) => {
  ...
  if (isCompactViewport) {
    ...
    if (asChild) {
      return /* @__PURE__ */ jsx(Slot, { ref, ...descriptionProps, children });
    }
    return /* @__PURE__ */ jsx("p", { ref, ...descriptionProps, children });
  }
  return /* @__PURE__ */ jsx(
    Description,
    {
...
var STATUS_LABELS = Object.fromEntries(
  STATUS_OPTIONS.map((option) => [option.value, option.label])
);
var PRIORITY_LABELS = Object.fromEntries(
  PRIORITY_OPTIONS.map((option) => [option.value, option.label])
);
function parseTaskId(subPath) {
...
function formatRelativeDate(value) {
  ...
  const days = Math.round((time - Date.now()) / 864e5);
  if (days === 0) return "today";
  if (days === -1) return "yesterday";
  if (days > -7 && days < 0) return `${Math.abs(days)}d ago`;
  return new Intl.DateTimeFormat(void 0, { month: "short", day: "numeric" }).format(time);
}
function taskMatchesProject(task, projectId) {
  return task.projectId === projectId || task.sharedProjectIds.includes(projectId);
}

// src/app/components/NewTaskDialog.tsx
var selectClass = "h-9 w-full rounded-md border border-input bg-transparent px-2.5 text-sm text-foreground outline-none focus:ring-1 focus:ring-ring";
function NewTaskDialog({
  ...
  return /* @__PURE__ */ jsx(Dialog2, { open, onOpenChange, children: /* @__PURE__ */ jsxs(DialogContent2, { className: "sm:max-w-lg", children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle2, { children: "New task" }),
      /* @__PURE__ */ jsx(DialogDescription2, { children: "Create a task without leaving BB." })
    ] }),
    /* @__PURE__ */ jsxs("form", { className: "grid gap-4", onSubmit: submit, children: [
      /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
        /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: "new-task-title", children: "Title" }),
        /* @__PURE__ */ jsx("input", { id: "new-task-title", autoFocus: true, value: title, onChange: (event) => setTitle(event.target.value), className: selectClass, placeholder: "What needs doing?" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
        /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: "new-task-description", children: "Description" }),
        /* @__PURE__ */ jsx("textarea", { id: "new-task-description", value: description, onChange: (event) => setDescription(event.target.value), className: "min-h-24 resize-y rounded-md border border-input bg-transparent px-2.5 py-2 text-sm outline-none focus:ring-1 focus:ring-ring", placeholder: "Context, acceptance criteria, links\u2026" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
        /* @__PURE__ */ jsx(FieldSelect, { label: "Project", id: "new-task-project", value: projectSlug, onChange: setProjectSlug, children: projects.map((project) => /* @__PURE__ */ jsx("option", { value: project.slug, children: project.name }, project.id)) }),
        /* @__PURE__ */ jsx(FieldSelect, { label: "Priority", id: "new-task-priority", value: priority, onChange: (value) => setPriority(value), children: PRIORITY_OPTIONS.map((option) => /* @__PURE__ */ jsx("option", { value: option.value, children: option.label }, option.value)) })
      ] }),
      /* @__PURE__ */ jsxs("details", { open: advancedOpen, onToggle: (event) => setAdvancedOpen(event.currentTarget.open), className: "rounded-md border border-border px-3", children: [
        /* @__PURE__ */ jsx("summary", { className: "cursor-pointer py-2.5 text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring", children: "More options" }),
        /* @__PURE__ */ jsxs("div", { className: "grid gap-3 border-t border-border py-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxs(FieldSelect, { label: "Visibility", id: "new-task-visibility", value: visibility, onChange: (value) => setVisibility(value), children: [
            /* @__PURE__ */ jsx("option", { value: "public", children: "Public to project" }),
            /* @__PURE__ */ jsx("option", { value: "assigned", children: "Private" }),
            /* @__PURE__ */ jsx("option", { value: "personal", children: "Personal" })
          ] }),
          /* @__PURE__ */ jsxs(FieldSelect, { label: "Assignee", id: "new-task-assignee", value: assigneeId, onChange: setAssigneeId, children: [
          ...
          /* @__PURE__ */ jsxs(FieldSelect, { label: "Parent task (optional)", id: "new-task-parent", value: parent, onChange: setParent, children: [
            /* @__PURE__ */ jsx("option", { value: "", children: "Top-level task" }),
            parentOptions.map((task) => /* @__PURE__ */ jsx("option", { value: task.id, children: task.title }, task.id))
          ] })
        ] })
      ] }),
      error ? /* @__PURE__ */ jsx("p", { className: "text-sm text-destructive", role: "alert", children: error }) : null,
      /* @__PURE__ */ jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsx(DialogClose2, { asChild: true, children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "ghost", disabled: saving, children: "Cancel" }) }),
        /* @__PURE__ */ jsx(Button, { type: "submit", disabled: saving, children: saving ? "Creating\u2026" : "Create task" })
      ] })
    ] })
  ] }) });
}
function FieldSelect({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
    /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: id, children: label }),
    /* @__PURE__ */ jsx("select", { id, value, onChange: (event) => onChange(event.target.value), className: selectClass, children })
  ] });
}

// src/app/components/StatusPill.tsx
function StatusPill({ status }) {
  const tone = status === "done" ? "bg-secondary text-secondary-foreground" : status === "in_progress" ? "bg-primary/15 text-primary" : status === "backlog" ? "bg-muted text-muted-foreground" : "bg-state-active text-foreground";
  return /* @__PURE__ */ jsx("span", { className: `inline-flex whitespace-nowrap rounded-full px-2 py-0.5 text-[11px] font-medium ${tone}`, children: STATUS_LABELS[status] });
}
function PriorityPill({ priority }) {
  const dot = priority === "urgent" ? "bg-destructive" : priority === "high" ? "bg-primary" : priority === "medium" ? "bg-secondary-foreground" : "bg-muted-foreground";
  return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 text-[11px] text-muted-foreground", title: `Priority: ${PRIORITY_LABELS[priority]}`, children: [
    /* @__PURE__ */ jsx("span", { className: `size-1.5 rounded-full ${dot}`, "aria-hidden": "true" }),
    PRIORITY_LABELS[priority]
  ] });
}

// src/app/components/TaskRow.tsx
function TaskRow({ task, onOpen }) {
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(StatusDot, { status: task.status }),
        /* @__PURE__ */ jsxs("span", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsx("span", { className: `block truncate text-[13px] ${task.status === "done" ? "text-muted-foreground line-through" : "text-foreground"}`, children: task.title }),
          /* @__PURE__ */ jsxs("span", { className: "mt-1 flex min-w-0 items-center gap-2 text-[11px] text-muted-foreground", children: [
            /* @__PURE__ */ jsx(PriorityPill, { priority: task.priority }),
            task.linkedThreadId ? /* @__PURE__ */ jsx("span", { className: "truncate text-primary", children: "Linked to BB" }) : null
          ] })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "shrink-0 text-xs text-muted-foreground", "aria-hidden": "true", children: "\u203A" })
      ]
    }
  );
}
function StatusDot({ status }) {
  const tone = status === "done" ? "bg-muted-foreground" : status === "in_progress" ? "bg-primary" : status === "backlog" ? "bg-muted-foreground/60" : "bg-foreground";
  return /* @__PURE__ */ jsx("span", { className: `size-2 shrink-0 rounded-full ${tone}`, "aria-hidden": "true" });
}
...
var CONTROL_HOVER_TRANSITION2 = "transition-colors duration-150 hover:duration-0";

// src/components/ui/button.tsx
var buttonVariants2 = cva(
  `inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ${CONTROL_HOVER_TRANSITION2} focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0`,
  {
    variants: {
      variant: {
        default: "bg-foreground text-background hover:bg-foreground/90",
...
// src/thread-prompt.ts
function buildTaskPrompt(task, baseUrl) {
...
// src/app/panels/TaskDetail.tsx
function TaskDetail({ subPath, onClose }) {
  const taskId = parseTaskId(subPath);
  if (!taskId) return /* @__PURE__ */ jsx(NoTaskSelected, {});
  return /* @__PURE__ */ jsx(TaskDetailContent, { taskId, onClose }, taskId);
}
function TaskDetailContent({ taskId, onClose }) {
  const rpc = useRpc();
  ...
  const [bbProjectId, setBbProjectId] = useState(null);
  ...
  async function patch(patch2) {
    if (!task) return;
    setSaving(true);
    try {
      const updated = await rpc.call("patchTask", { id: task.id, patch: patch2 });
      setDetail((current) => current ? { ...current, task: { ...updated, subtasks: current.task.subtasks } } : current);
      if (patch2.title !== void 0) setTitle(patch2.title);
      if (patch2.description !== void 0) setDescription(patch2.description);
    } catch (cause) {
  ...
  async function startThread(request) {
    if (!task) return;
  ...
  if (loading && !detail) return /* @__PURE__ */ jsx(DetailLoading, {});
  if (error && !detail) return /* @__PURE__ */ jsx(DetailError, { message: error, onRetry: () => void load() });
  if (!task || !detail) return /* @__PURE__ */ jsx(NoTaskSelected, {});
  const prompt = buildTaskPrompt(task, dispatchBaseUrl);
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full min-h-0 flex-col overflow-y-auto bg-background text-foreground", children: [
    /* @__PURE__ */ jsx("div", { className: "border-b border-border px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
          detail.project?.name ?? "Dispatch task",
          " \xB7 ",
          task.id
        ] }),
        /* @__PURE__ */ jsx("input", { value: title, onChange: (event) => setTitle(event.target.value), onBlur: () => {
          if (title.trim() && title.trim() !== task.title) void patch({ title: title.trim() });
        }, className: "mt-1 w-full min-w-0 border-0 bg-transparent p-0 text-balance text-base font-semibold outline-none focus:ring-0", "aria-label": "Task title" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-1", children: [
        task.assigneeIds.length === 0 ? /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "outline", onClick: () => void claimTask(), disabled: claimSaving, children: claimSaving ? "Claiming\u2026" : "Claim task" }) : null,
        onClose ? /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "ghost", onClick: onClose, children: "Close" }) : null,
        /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "ghost", onClick: () => setDeleteOpen(true), "aria-label": "Delete task", children: "Delete" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "min-h-0 flex-1 p-4", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-3xl space-y-4", children: [
      error ? /* @__PURE__ */ jsx("p", { className: "rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive", role: "alert", children: error }) : null,
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3 p-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
          /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: "task-description", children: "Description" }),
          /* @__PURE__ */ jsx("textarea", { id: "task-description", value: description, onChange: (event) => setDescription(event.target.value), onBlur: () => {
            if (description !== task.description) void patch({ description });
          }, className: "min-h-28 resize-y rounded-md border border-input bg-transparent px-3 py-2 text-sm leading-6 outline-none focus:ring-1 focus:ring-ring", placeholder: "Add context or acceptance criteria\u2026" }),
          task.description ? /* @__PURE__ */ jsxs("details", { className: "rounded-md border border-border px-3", children: [
            /* @__PURE__ */ jsx("summary", { className: "cursor-pointer py-2 text-xs font-medium text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring", children: "Preview" }),
            /* @__PURE__ */ jsx(Markdown, { content: task.description, className: "border-t border-border py-3 text-sm" })
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsx(FieldSelect2, { label: "Status", id: "task-status", value: task.status, onChange: (value) => void patch({ status: value }), children: STATUS_OPTIONS.map((option) => /* @__PURE__ */ jsx("option", { value: option.value, children: option.label }, option.value)) }),
          /* @__PURE__ */ jsx(FieldSelect2, { label: "Priority", id: "task-priority", value: task.priority, onChange: (value) => void patch({ priority: value }), children: PRIORITY_OPTIONS.map((option) => /* @__PURE__ */ jsx("option", { value: option.value, children: option.label }, option.value)) }),
          /* @__PURE__ */ jsxs(FieldSelect2, { label: "Visibility", id: "task-visibility", value: task.visibility, onChange: (value) => void patch({ visibility: value }), children: [
            /* @__PURE__ */ jsx("option", { value: "public", children: "Public to project" }),
            /* @__PURE__ */ jsx("option", { value: "assigned", children: "Private" }),
            /* @__PURE__ */ jsx("option", { value: "personal", children: "Personal" })
          ] }),
          /* @__PURE__ */ jsxs(FieldSelect2, { label: "Assignee", id: "task-assignee", value: currentAssignee, onChange: (value) => void patch({ assignee: value || null }), children: [
            /* @__PURE__ */ jsx("option", { value: "", children: "Unassigned" }),
            assigneeOptions.map((member) => /* @__PURE__ */ jsx("option", { value: member.id, children: member.name }, member.id))
          ] })
        ] }),
        saving ? /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Saving\u2026" }) : null
      ] }) }),
      /* @__PURE__ */ jsxs("section", { className: "space-y-2", "aria-labelledby": "subtasks-heading", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between gap-3", children: /* @__PURE__ */ jsxs("h2", { id: "subtasks-heading", className: "text-sm font-semibold", children: [
          "Subtasks ",
        ...
        /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "p-0", children: [
          detail.subtasks.length === 0 ? /* @__PURE__ */ jsx("p", { className: "px-3 py-4 text-sm text-muted-foreground", children: "No subtasks yet." }) : detail.subtasks.map((subtask) => /* @__PURE__ */ jsx(SubtaskRow, { task: subtask, onOpen: () => navigate.toPluginPanel("tasks", { subPath: `task/${encodeURIComponent(subtask.id)}` }) }, subtask.id)),
          detail.project ? /* @__PURE__ */ jsxs("form", { className: "flex gap-2 border-t border-border p-3", onSubmit: addSubtask, children: [
            /* @__PURE__ */ jsx("label", { className: "sr-only", htmlFor: "new-subtask-title", children: "New subtask" }),
            /* @__PURE__ */ jsx("input", { id: "new-subtask-title", value: subtaskTitle, onChange: (event) => setSubtaskTitle(event.target.value), className: "h-8 min-w-0 flex-1 rounded-md border border-input bg-transparent px-2.5 text-sm outline-none focus:ring-1 focus:ring-ring", placeholder: "Add a subtask\u2026" }),
            /* @__PURE__ */ jsx(Button, { type: "submit", size: "sm", variant: "outline", disabled: subtaskSaving || !subtaskTitle.trim(), children: subtaskSaving ? "Adding\u2026" : "Add" })
          ] }) : null
        ] }) })
      ] }),
      /* @__PURE__ */ jsxs("section", { className: "space-y-2", "aria-labelledby": "comments-heading", children: [
        /* @__PURE__ */ jsx("h2", { id: "comments-heading", className: "text-sm font-semibold", children: "Comments" }),
        /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3 p-3", children: [
          comments.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "No comments yet." }) : comments.map((item) => /* @__PURE__ */ jsx(CommentRow, { comment: item }, item.id)),
          /* @__PURE__ */ jsxs("form", { className: "flex items-end gap-2 border-t border-border pt-3", onSubmit: addComment, children: [
            /* @__PURE__ */ jsx("label", { className: "sr-only", htmlFor: "task-comment", children: "Add a comment" }),
            /* @__PURE__ */ jsx("textarea", { id: "task-comment", value: comment, onChange: (event) => setComment(event.target.value), className: "min-h-9 flex-1 resize-y rounded-md border border-input bg-transparent px-2.5 py-2 text-sm outline-none focus:ring-1 focus:ring-ring", placeholder: "Write a progress note\u2026" }),
            /* @__PURE__ */ jsx(Button, { type: "submit", size: "sm", disabled: commentSaving || !comment.trim(), children: commentSaving ? "Sending\u2026" : "Comment" })
          ] })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxs("section", { className: "space-y-2", "aria-labelledby": "thread-heading", children: [
        /* @__PURE__ */ jsx("h2", { id: "thread-heading", className: "text-sm font-semibold", children: "Work in BB" }),
        task.linkedThreadId ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-wrap items-center justify-between gap-3 p-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: "This task is linked to a BB thread." }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "The agent receives the task context and the Dispatch workflow." })
          ] }),
          /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", onClick: () => navigate.toThread(task.linkedThreadId), children: "Open thread" })
        ] }) }) : showComposer ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "p-3", children: /* @__PURE__ */ jsx(experimental_NewThreadComposer, { defaultProjectId: bbProjectId ?? void 0, initialPrompt: prompt, layout: "document", draftKey: `dispatch-task-${task.id}`, onSubmit: startThread }) }) }) : /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-wrap items-center justify-between gap-3 p-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: "Ready to hand this task to an agent?" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "You can adjust the project, model, environment, and permissions before sending." })
          ] }),
          /* @__PURE__ */ jsx(Button, { type: "button", onClick: () => setShowComposer(true), children: "Start thread" })
        ] }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx(AlertDialog2, { open: deleteOpen, onOpenChange: setDeleteOpen, children: /* @__PURE__ */ jsxs(AlertDialogContent2, { children: [
      /* @__PURE__ */ jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsx(AlertDialogTitle2, { children: "Delete this task?" }),
        /* @__PURE__ */ jsxs(AlertDialogDescription2, { children: [
          "This removes \u201C",
          task.title,
          "\u201D from Dispatch. Any subtasks will be removed with it."
        ] })
      ] }),
      /* @__PURE__ */ jsxs(AlertDialogFooter, { children: [
        /* @__PURE__ */ jsx(AlertDialogCancel2, { children: "Cancel" }),
        /* @__PURE__ */ jsx(AlertDialogAction2, { onClick: (event) => {
          event.preventDefault();
          void deleteTask();
        }, className: "bg-destructive text-destructive-foreground hover:bg-destructive/90", children: "Delete task" })
      ] })
    ] }) })
  ] });
}
function FieldSelect2({ label, id, value, onChange, children }) {
  return /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
    /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: id, children: label }),
    /* @__PURE__ */ jsx("select", { id, value, onChange: (event) => onChange(event.target.value), className: "h-9 w-full rounded-md border border-input bg-transparent px-2.5 text-sm outline-none focus:ring-1 focus:ring-ring", children })
  ] });
}
function SubtaskRow({ task, onOpen }) {
  return /* @__PURE__ */ jsxs("button", { type: "button", onClick: onOpen, className: "flex w-full items-center gap-2 border-b border-border/70 px-3 py-2 text-left text-sm last:border-b-0 hover:bg-state-hover focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring", children: [
    /* @__PURE__ */ jsx(StatusPill, { status: task.status }),
    /* @__PURE__ */ jsx("span", { className: "min-w-0 flex-1 truncate", children: task.title }),
    /* @__PURE__ */ jsx("span", { className: "text-[11px] text-muted-foreground", children: PRIORITY_LABELS[task.priority] })
  ] });
}
function CommentRow({ comment }) {
  return /* @__PURE__ */ jsxs("article", { className: "space-y-1 rounded-md bg-muted/35 px-3 py-2", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2 text-[11px] text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("time", { dateTime: comment.createdAt, children: formatRelativeDate(comment.createdAt) })
    ] }),
    /* @__PURE__ */ jsx("p", { className: "whitespace-pre-wrap text-sm leading-5 text-foreground", children: comment.body })
  ] });
}
function NoTaskSelected() {
  return /* @__PURE__ */ jsx("div", { className: "flex h-full items-center justify-center p-6 text-center text-sm text-muted-foreground", children: "Select a task to open its details." });
}
function DetailLoading() {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4 p-4", children: [
    /* @__PURE__ */ jsx("div", { className: "h-6 w-40 rounded bg-muted" }),
    /* @__PURE__ */ jsx("div", { className: "h-48 rounded-lg border border-border bg-card" }),
    /* @__PURE__ */ jsx("div", { className: "h-32 rounded-lg border border-border bg-card" })
  ] });
}
function DetailError({ message, onRetry }) {
  return /* @__PURE__ */ jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Could not open task" }),
      /* @__PURE__ */ jsx(CardDescription, { children: message })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", onClick: onRetry, children: "Try again" }) })
  ] }) });
}

// src/app/pages/DispatchPage.tsx
function DispatchPage({ subPath }) {
  const rpc = useRpc();
  const navigate = useBbNavigate();
  ...
  useEffect(() => {
    void refresh();
    const interval = window.setInterval(() => void refresh(), 3e4);
    return () => window.clearInterval(interval);
  }, [refresh]);
  useEffect(() => {
    if (quickProject) return;
    const mapped = currentBbProjectId ? mappedProjects[currentBbProjectId] : void 0;
    setQuickProject(mapped ?? remoteProjects[0]?.slug ?? "");
  }, [currentBbProjectId, mappedProjects, quickProject, remoteProjects]);
  const projectOptions = remoteProjects.length > 0 ? remoteProjects : data ? Object.values(data.projects) : [];
  ...
  if (loading && !status) return /* @__PURE__ */ jsx(LoadingState, {});
  if (!status?.connected) return /* @__PURE__ */ jsx(ConnectionCard, { error: status?.error ?? error });
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full min-h-0 bg-background text-foreground", children: [
    /* @__PURE__ */ jsxs("div", { className: `flex min-w-0 flex-1 flex-col ${taskId ? "hidden md:flex" : ""}`, children: [
      /* @__PURE__ */ jsx("div", { className: "border-b border-border px-4 py-4 md:px-5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-4xl space-y-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-balance text-lg font-semibold", children: "My work" }),
            /* @__PURE__ */ jsxs("p", { className: "mt-1 text-pretty text-xs text-muted-foreground", children: [
              "Assigned to ",
              status.user?.name ?? "you",
              "."
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "ghost", onClick: () => void refresh(), disabled: loading, children: "Refresh" }),
            /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", onClick: () => setNewTaskOpen(true), children: "New task" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("form", { className: "flex flex-wrap gap-2", onSubmit: createQuickTask, "aria-label": "Quick add task", children: [
          /* @__PURE__ */ jsx("label", { className: "sr-only", htmlFor: "quick-add-title", children: "Quick add task" }),
          /* @__PURE__ */ jsx("input", { id: "quick-add-title", value: quickTitle, onChange: (event) => setQuickTitle(event.target.value), placeholder: "Add a task\u2026", className: "h-9 min-w-48 flex-1 rounded-md border border-input bg-transparent px-3 text-sm outline-none focus:ring-1 focus:ring-ring" }),
          /* @__PURE__ */ jsx("label", { className: "sr-only", htmlFor: "quick-add-project", children: "Project for quick add" }),
          /* @__PURE__ */ jsx("select", { id: "quick-add-project", value: quickProject, onChange: (event) => setQuickProject(event.target.value), className: "h-9 max-w-52 rounded-md border border-input bg-transparent px-2.5 text-sm outline-none focus:ring-1 focus:ring-ring", children: projectOptions.map((project) => /* @__PURE__ */ jsx("option", { value: project.slug, children: project.name }, project.id)) }),
          /* @__PURE__ */ jsx(Button, { type: "submit", size: "sm", variant: "outline", disabled: !quickTitle.trim() || !quickProject, children: "Add" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex rounded-md border border-border p-0.5", role: "tablist", "aria-label": "Task view", children: [
            /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "ghost", role: "tab", "aria-selected": tab === "mine", onClick: () => setTab("mine"), className: tab === "mine" ? "bg-state-active text-foreground" : "text-muted-foreground", children: "Mine" }),
            /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "ghost", role: "tab", "aria-selected": tab === "unclaimed", onClick: () => setTab("unclaimed"), className: tab === "unclaimed" ? "bg-state-active text-foreground" : "text-muted-foreground", children: "Unclaimed" })
          ] }),
          /* @__PURE__ */ jsxs(
            Button,
            {
              ...
              children: [
                "Filters",
                activeFilterCount > 0 ? ` \xB7 ${activeFilterCount}` : ""
              ]
            }
          )
        ] }),
        filtersOpen ? /* @__PURE__ */ jsxs("div", { id: "task-filters", className: "grid gap-3 rounded-md border border-border bg-card p-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: "task-status-filter", children: "Status" }),
            /* @__PURE__ */ jsxs("select", { id: "task-status-filter", value: statusFilter, onChange: (event) => setStatusFilter(event.target.value), className: "h-9 rounded-md border border-input bg-transparent px-2.5 text-sm outline-none focus:ring-1 focus:ring-ring", children: [
              /* @__PURE__ */ jsx("option", { value: "open", children: "Open tasks" }),
              /* @__PURE__ */ jsx("option", { value: "all", children: "All tasks" }),
              STATUS_OPTIONS.map((option) => /* @__PURE__ */ jsx("option", { value: option.value, children: option.label }, option.value))
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: "task-project-filter", children: "Project" }),
            /* @__PURE__ */ jsxs("select", { id: "task-project-filter", value: projectFilter, onChange: (event) => setProjectFilter(event.target.value), className: "h-9 rounded-md border border-input bg-transparent px-2.5 text-sm outline-none focus:ring-1 focus:ring-ring", children: [
              /* @__PURE__ */ jsx("option", { value: "all", children: "All projects" }),
              projectOptions.map((project) => /* @__PURE__ */ jsx("option", { value: project.id, children: project.name }, project.id))
            ] })
          ] })
        ] }) : null
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "min-h-0 flex-1 overflow-y-auto px-4 py-4 md:px-5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-4xl space-y-3", children: [
        error ? /* @__PURE__ */ jsx("p", { className: "rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive", role: "alert", children: error }) : null,
        grouped.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { tab, onCreate: () => setNewTaskOpen(true) }) : grouped.map(([projectId, tasks]) => /* @__PURE__ */ jsx(Card, { className: "overflow-hidden", children: /* @__PURE__ */ jsxs("details", { open: true, children: [
          /* @__PURE__ */ jsxs("summary", { className: "flex cursor-pointer list-none items-center justify-between px-3 py-2.5 text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring", children: [
            /* @__PURE__ */ jsxs("span", { className: "flex min-w-0 items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-primary", "aria-hidden": "true" }),
              projectById[projectId]?.name ?? "Unknown project"
            ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "border-t border-border", children: tasks.map((task) => /* @__PURE__ */ jsx(
            TaskRow,
            {
              task,
    ...
    taskId ? /* @__PURE__ */ jsx("aside", { className: "min-w-0 flex-1 shrink-0 border-l border-border bg-background md:flex-none md:w-[30rem] lg:w-[34rem]", "aria-label": "Task details", children: /* @__PURE__ */ jsx(TaskDetail, { subPath, onClose: () => navigate.toPluginPanel("tasks", { subPath: "" }) }) }) : null
  ] });
}
function LoadingState() {
  return /* @__PURE__ */ jsx("div", { className: "h-full overflow-y-auto p-4 md:p-5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-4xl space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx("div", { className: "h-5 w-28 rounded bg-muted" }),
        /* @__PURE__ */ jsx("div", { className: "h-3 w-36 rounded bg-muted" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "h-8 w-24 rounded bg-muted" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "h-9 w-full rounded-md bg-muted" }),
    /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-lg border border-border bg-card", children: [1, 2, 3, 4].map((row) => /* @__PURE__ */ jsx("div", { className: "h-14 border-b border-border/70 last:border-b-0" }, row)) })
  ] }) });
}
function ConnectionCard({ error }) {
  return /* @__PURE__ */ jsx("div", { className: "h-full overflow-y-auto p-4 md:p-5", children: /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-xl pt-8", children: /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { className: "text-balance", children: "Connect Dispatch" }),
      /* @__PURE__ */ jsx(CardDescription, { className: "text-pretty", children: "Add a Dispatch API key in the plugin settings to see your tasks here." })
    ] }),
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3 text-sm text-muted-foreground", children: [
      error ? /* @__PURE__ */ jsx("p", { className: "rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-destructive", role: "alert", children: error }) : null,
      /* @__PURE__ */ jsx("p", { children: "Open Settings \u2192 Extensions \u2192 Dispatch. You can paste a key, import the key used by the CLI, or sign in with your email and password." }),
      /* @__PURE__ */ jsx("p", { className: "text-xs", children: "The API key stays on BB\u2019s server and is never exposed to this page." })
    ] })
  ] }) }) });
}
function EmptyState({ tab, onCreate }) {
  return /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-col items-start gap-3 py-10", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-balance font-medium", children: tab === "mine" ? "No open tasks" : "No unclaimed tasks" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-pretty text-sm text-muted-foreground", children: tab === "mine" ? "Create a task or open Filters to see completed work." : "Everything visible to you is already claimed." })
    ] }),
    /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", onClick: onCreate, children: "Create a task" })
  ] }) });
}

// src/app/settings/ConnectionSection.tsx
var inputClass = "h-9 w-full rounded-md border border-input bg-transparent px-3 text-sm outline-none focus:ring-1 focus:ring-ring";
function ConnectionSection() {
  ...
  useEffect(() => {
    void rpc.call("status").then(setStatus, () => void 0);
  }, [rpc]);
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsx(CardTitle, { children: "Dispatch connection" }),
      /* @__PURE__ */ jsx(CardDescription, { children: "Choose how this BB host should access your Dispatch tasks. Secrets are stored server-side." })
    ] }),
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
        /* @__PURE__ */ jsx("label", { className: "text-xs font-medium", htmlFor: "dispatch-base-url", children: "Dispatch URL" }),
        /* @__PURE__ */ jsx("input", { id: "dispatch-base-url", value: baseUrl, onChange: (event) => setBaseUrl(event.target.value), className: inputClass, disabled: settingsLoading || busy !== null })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-3 rounded-md border border-border p-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-medium", children: "Use an API key" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Paste a personal key from Dispatch. It is never sent to the browser page after saving." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsx("label", { className: "sr-only", htmlFor: "dispatch-api-key", children: "Dispatch API key" }),
          /* @__PURE__ */ jsx("input", { id: "dispatch-api-key", type: "password", value: apiKey, onChange: (event) => setApiKey(event.target.value), className: `${inputClass} min-w-56 flex-1`, placeholder: "dsp_\u2026", autoComplete: "off" }),
          /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", onClick: () => void saveKey(), disabled: busy !== null, children: busy === "key" ? "Saving\u2026" : "Save key" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-2 rounded-md border border-border p-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-medium", children: "Use the CLI key" }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
            "Read ",
            /* @__PURE__ */ jsx("code", { className: "rounded bg-muted px-1", children: "~/.dispatch/config.json" }),
            " from the connected BB host."
          ] })
        ] }),
        /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "outline", onClick: () => void importCliKey(), disabled: busy !== null, children: busy === "cli" ? "Importing\u2026" : "Use CLI key" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-3 rounded-md border border-border p-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-medium", children: "Sign in with Dispatch" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "This issues a separate API key labelled for the BB plugin." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid gap-2 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "sr-only", htmlFor: "dispatch-email", children: "Email" }),
            /* @__PURE__ */ jsx("input", { id: "dispatch-email", type: "email", value: email, onChange: (event) => setEmail(event.target.value), className: inputClass, placeholder: "you@example.com", autoComplete: "email" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "sr-only", htmlFor: "dispatch-password", children: "Password" }),
            /* @__PURE__ */ jsx("input", { id: "dispatch-password", type: "password", value: password, onChange: (event) => setPassword(event.target.value), className: inputClass, placeholder: "Password", autoComplete: "current-password" })
          ] })
        ] }),
        /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "outline", onClick: () => void signIn(), disabled: busy !== null, children: busy === "login" ? "Signing in\u2026" : "Sign in" })
      ] }),
      error ? /* @__PURE__ */ jsx("p", { className: "rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive", role: "alert", children: error }) : null,
      status?.connected ? /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "Connected as ",
        /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground", children: status.user?.name }),
        " \xB7 ",
        status.baseUrl
      ] }) : status?.error ? /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "Not connected: ",
        status.error
      ] }) : null
    ] })
